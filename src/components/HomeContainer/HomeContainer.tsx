        ...
        >
          <Container maxWidth="md">
            ...
            <Typography variant="body1" paragraph>
              ...
              among developers worldwide. Whether you are a seasoned
              professional or just starting your journey in the world of coding,
              CollabDev offers you the opportunity to connect with like-minded
              individuals, explore exciting projects, and embark on
              collaborative endeavors that push the boundaries of innovation.
            </Typography>
            <Typography variant="body1" paragraph>
